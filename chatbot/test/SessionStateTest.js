...
let { SessionState, SessionState_Alvis } = require('../SessionState.js');
...
// since the SessionState_Alvis class is a very simple subclass of SessionState
// we are just doing some basic sanity checking here, not a comprehensive test suite

describe('SessionState_Alvis', () => {

    let state

    beforeEach(function() {
        state = new SessionState_Alvis(sessionId, installationId, buttonId, unit, phoneNumber, STATES.STARTED, 1, createdAt, updatedAt, null, null);
    })
