...
module.exports.commitTransaction = async function() {
    await client.query("COMMIT")
}

module.exports.getUnrespondedSessionWithPhoneNumber = async function(phoneNumber) {
...
module.exports.getMostRecentIncompleteSessionWithPhoneNumber = async function(phoneNumber) {
...
module.exports.getAllSessionsWithPhoneNumber = async function(phoneNumber) {
...
module.exports.getAllSessions = async function() {
    const { rows } = await client.query("SELECT * FROM sessions")
    return rows.map(createSessionFromRow)
}

module.exports.createSession = async function(buttonId, unit, phoneNumber, numPresses) {
...
module.exports.saveSession = async function(session) {
...
module.exports.clearSessions = async function() {
...
module.exports.getButtonWithButtonId = async function(buttonId) {
...
module.exports.createButton = async function(buttonId, unit, phoneNumber) {
    await client.query("INSERT INTO registry (button_id, unit, phone_number) VALUES ($1, $2, $3)", [buttonId, unit, phoneNumber])
}

module.exports.clearButtons = async function() {
    if(process.env.NODE_ENV !== "test") {
